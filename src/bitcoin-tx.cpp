...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " yodycoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  yodycoin-tx [options] <hex-tx> [commands]  Update hex-encoded yodycoin transaction\n" +
            "or:     yodycoin-tx [options] -create [commands]   Create hex-encoded yodycoin transaction\n" +
            "\n";
