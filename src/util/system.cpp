...
const char * const BITCOIN_CONF_FILENAME = "yodycoin.conf";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Yodycoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Yodycoin";
#else
    // Unix
    return pathRet / ".yodycoin";
#endif
#endif
}
