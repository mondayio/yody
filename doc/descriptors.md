# Support for Output Descriptors in Yodycoin Core

Since Yodycoin Core v0.17, there is support for Output Descriptors. This is a
...
on Yodycoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Yodycoin Core wallets, a convenience function `combo` is
