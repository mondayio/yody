...
"""Verify that starting yodycoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start yodycoin with -h for help text")
        ...
        self.log.info("Start yodycoin with -version for version information")
        ...
        self.log.info("Start yodycoind with -fakearg to make sure it does not start")
